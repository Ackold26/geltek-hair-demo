...
(function () {
  ...
  /* ---------- Единый обработчик прокрутки: два типа эффектов на элементах секций ----------
     ...
     - data-par="<амплитуда в cqw>" — относительное смещение translateY от 0 до +амплитуда
       ...
       data-scroll-y0/y1). Часть амплитуд снижена против макетных по замечаниям клиента о
       скорости: плашки экранов 2/3/4 — вдвое (24.531 → 12.266), круги «до/после» экрана 7 —
       на 60% (12.969 → 5.188). Отсчёт от 0, а не от -амплитуда/2 — по замечанию
